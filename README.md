...
* **Debugging Support**: Debugging flags (`-debug all`) enabled during compilation for easier troubleshooting.
...
* Run the simulation in non-GUI mode (`-nocl`).
...
Further documentation can be found in the `docs/` directory. This includes detailed descriptions of the components, test cases, and simulation strategies.
